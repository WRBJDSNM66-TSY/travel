    ...
    sql="select * from user";
 	...
 	while(r.next()){
 		...
 		if(Stu_id.equals(user)){
 			...
 			String sql1="insert into user values ('"+Stu_id+"','"+U_password+"','"+role+"')";
 			stmt.executeUpdate(sql1);
 			%>
 			<p>注册成功！！！</p>
 			<p>三秒钟后自动转到查看页面！！！</p>
 			<meta http-equiv="refresh" content="3;url=http://localhost:8080/BigWork/manage1.jsp" />
 		    <p>如果没有跳转，请点击<a href="manage1.jsp">这里</a></p>
 			<%
 		}
 	}
 	r.close();
